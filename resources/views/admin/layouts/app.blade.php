...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('admin.home')}}" class="logo">
      ...
      <span class="logo-lg"><b>PUBG</b>TOWN</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Contest</span>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Deposit</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('admin.deposits')}}">View All</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Eat, Sleep and Rave PUBG
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="#">PUBGTown</a>.</strong> All rights reserved.
  </footer>
